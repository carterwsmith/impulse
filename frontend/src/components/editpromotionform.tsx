...
export default function EditPromotionForm({ edited_promotion, session_user_id, dialogSetter, tableDataFetcher }: { edited_promotion: any, session_user_id: any, dialogSetter: any, tableDataFetcher: any }) {
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
        is_active: edited_promotion.is_active,
        impulse_user_id: edited_promotion.impulse_user_id,
        is_ai_generated: edited_promotion.is_ai_generated,
        ai_description: edited_promotion.ai_description ? edited_promotion.ai_description : '',
        ai_discount_percent_min: edited_promotion.ai_discount_percent_min ? edited_promotion.ai_discount_percent_min : 0, // Ensure this is a sensible default
        ai_discount_percent_max: edited_promotion.ai_discount_percent_max ? edited_promotion.ai_discount_percent_max : 0, // Ensure this is a sensible default
        ai_discount_dollars_min: edited_promotion.ai_discount_dollars_min ? edited_promotion.ai_discount_dollars_min : 0, // Ensure this is a sensible default
        ai_discount_dollars_max: edited_promotion.ai_discount_dollars_max ? edited_promotion.ai_discount_dollars_max : 0, // Ensure this is a sensible default
        promotion_name: edited_promotion.promotion_name,
        image_url: edited_promotion.image_url ? edited_promotion.image_url : '',
        display_title: edited_promotion.display_title ? edited_promotion.display_title : '',
        display_description: edited_promotion.display_description ? edited_promotion.display_description : '',
        discount_percent: edited_promotion.discount_percent ? edited_promotion.discount_percent : 0, // Ensure this is a sensible default
        discount_dollars: edited_promotion.discount_dollars ? edited_promotion.discount_dollars : 0, // Ensure this is a sensible default
        discount_code: edited_promotion.discount_code ? edited_promotion.discount_code : '',
    }
  })
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    .then(data => {
        ...
        tableDataFetcher();
        // emit toast
        toast(`Promotion successfully updated.`)
    })
    .catch((error) => {
